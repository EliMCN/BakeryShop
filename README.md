The Bakery Shop 
Aplicación web de e-commerce construida con React para una panadería artesanal, que incluye un catálogo de productos, carrito de compras y un panel de administración dashboard de productos (crud). Este proyecto se desarrolla como trabajo final de la C25232 ReactJs de Talento Tech.
...
Catálogo de Productos: Visualiza los productos disponibles en la página de inicio (Home) con Limit para productos destacados y la sección de productos permite listarlos todos.
...
bash
git clone https://github.com/EliMCN/BakeryShop
cd BakeryShop
...
Haz clic en "Admin Login" en el menú de navegación.
Usa las siguientes credenciales para iniciar sesión:
Usuario: admin
Contraseña: 1234
Serás redirigido al panel de administración (/admin), donde podrás ver la lista de productos y empezar a gestionarlos.
